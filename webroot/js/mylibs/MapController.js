...
MapController.prototype.fetchData = function() {
  return data;
};
MapController.prototype.sortLocations = function(locations) {
  //sort locations and return it as an array of objects
  return locations;
};
MapController.prototype.renderLocations = function(locations) {
  //private variables go here
  var privateVar = "hello";
  return function() {
    //render out the chcklist
  };
};
MapController.prototype.renderTooltips = function() {
...
var loader = {
  complete : false,
   ...
   activate : function() {
       $('#loadingScreen').hide('fade',500);
       $('.left').show('fade', 500);
       this.complete = true;
   },
   onReady: function() {
       $('#loader-img').attr('src', 'img/road-ready.gif');
       $('#loader-msg').text("Data hentet");
       $('#loader-img').css('cursor', 'pointer');
       $('#loader-img').bind('click', function(){
           loader.activate();
       });
   },
   onError: function(code) {
       $('#loader-img').attr('src', 'img/road-fail.gif');
       $('#loader-msg').text("Feil "+code+"! Prøv på nytt");
   }
};
